...
#if defined(NDEBUG)
# error "Pbcchain cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Pbcchain Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if (nHeight==1)nSubsidy = 2000000000 * COIN;else nSubsidy >>= halvings;
    return nSubsidy;
}
...
void ThreadScriptCheck() {
    RenameThread("pbcchain-scriptch");
