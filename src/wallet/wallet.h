...
#ifndef PBCCHAIN_WALLET_WALLET_H
#define PBCCHAIN_WALLET_WALLET_H
...
public:
     ...
     * on this pbcchain node, and set to 0 for transactions that were created
...
#endif // PBCCHAIN_WALLET_WALLET_H
