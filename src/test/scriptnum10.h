...
#ifndef PBCCHAIN_TEST_SCRIPTNUM10_H
#define PBCCHAIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Pbcchain Core 0.10.0, for cross-comparison.
 */
public:
