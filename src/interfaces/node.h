...
#ifndef PBCCHAIN_INTERFACES_NODE_H
#define PBCCHAIN_INTERFACES_NODE_H
...
//! Top-level interface for a pbcchain node (pbcchaind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // PBCCHAIN_INTERFACES_NODE_H
