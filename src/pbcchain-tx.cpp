...
static void SetupPbcchainTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " pbcchain-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  pbcchain-tx [options] <hex-tx> [commands]  Update hex-encoded pbcchain transaction\n" +
            "or:     pbcchain-tx [options] -create [commands]   Create hex-encoded pbcchain transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pbcchain transaction
