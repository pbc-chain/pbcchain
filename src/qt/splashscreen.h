...
#ifndef PBCCHAIN_QT_SPLASHSCREEN_H
#define PBCCHAIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Pbcchain Core initialization
...
#endif // PBCCHAIN_QT_SPLASHSCREEN_H
