...
#ifndef PBCCHAIN_QT_PBCCHAINUNITS_H
#define PBCCHAIN_QT_PBCCHAINUNITS_H
...
/** Pbcchain unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PbcchainUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PbcchainUnits(QObject *parent);

    /** Pbcchain units.
      @note Source: https://en.pbcchain.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        PBC,
...
typedef PbcchainUnits::Unit PbcchainUnit;

#endif // PBCCHAIN_QT_PBCCHAINUNITS_H
