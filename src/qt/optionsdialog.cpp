    ...
    mapper(0)
{
    ...
    ui->pbcchainAtStartup->setToolTip(ui->pbcchainAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->pbcchainAtStartup->setText(ui->pbcchainAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openPbcchainConfButton->setToolTip(ui->openPbcchainConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new PbcchainUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->pbcchainAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPbcchainConfButton_clicked()
{
