 ...
 */
#ifndef PBCCHAIN_UTIL_H
#define PBCCHAIN_UTIL_H
...
extern const char * const PBCCHAIN_CONF_FILENAME;
extern const char * const PBCCHAIN_PID_FILENAME;
...
{
    std::string s = strprintf("pbcchain-%s", name);
