Pbcchain Core version 0.9.4 is now available from:

  https://pbcchain.org/bin/0.9.4/
...
this update is incompatible with the Pbcchain system and could lead to consensus
forks.

Pbcchain Core released binaries from https://pbcchain.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~pbcchain/+archive/ubuntu/pbcchain
- A third-party or self-compiled Pbcchain Core

upgrade to Pbcchain Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
