Pbcchain Core version 0.16.1 is now available from:

  <https://pbcchaincore.org/bin/pbcchain-core-0.16.1/>
...
- #12843 `df38b13` Test starting pbcchaind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure pbcchaind processes are cleaned up when tests end (sdaftuar)
