Pbcchain version 0.5.4 is now available for download at:
http://sourceforge.net/projects/pbcchain/files/Pbcchain/pbcchain-0.5.4/
...
http://gitorious.org/pbcchain/pbcchaind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Pbcchain-Qt notifications under Growl 1.3.
Increase required age of Pbcchain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPbcchain properly when installing Pbcchain-Qt over it. (Windows)
