Pbcchain Core version 0.10.4 is now available from:

  <https://pbcchain.org/bin/pbcchain-core-0.10.4/>
...
- #6953 `43c2789` Split pbcchain-tx into its own package
- #6953 `dfe0d4d` Include pbcchain-tx binary on Debian/Ubuntu
