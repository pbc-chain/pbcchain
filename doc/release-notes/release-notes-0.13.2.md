Pbcchain Core version 0.13.2 is now available from:

  <https://pbcchain.org/bin/pbcchain-core-0.13.2/>
...
- #8908 `4a974b2` Update pbcchain-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow pbcchain-tx to create v2 transactions (btcdrak)
