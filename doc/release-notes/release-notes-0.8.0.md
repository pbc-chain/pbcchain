Pbcchain-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/pbcchain/files/Pbcchain/pbcchain-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Pbcchain
...
New/changed settings (command-line or pbcchain.conf file)
--------------------------------------------------------
