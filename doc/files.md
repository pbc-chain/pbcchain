...
* pbcchain.conf: contains configuration settings for pbcchaind or pbcchain-qt
* pbcchaind.pid: stores the process id of pbcchaind while running
...
* debug.log: contains debug information and general logging generated by pbcchaind or pbcchain-qt
