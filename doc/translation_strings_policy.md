...
This document provides guidelines for internationalization of the Pbcchain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `pbcchain_en.ts` remains unchanged.
