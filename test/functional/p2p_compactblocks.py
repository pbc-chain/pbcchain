...
# TestP2PConn: A peer we use to send messages to pbcchaind, and store responses.
...
class CompactBlocksTest(PbcchainTestFramework):
    ...
    # This test actually causes pbcchaind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that pbcchaind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for pbcchaind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # pbcchaind will not send blocktxn responses for blocks whose height is
