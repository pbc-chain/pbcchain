...
"""Verify that starting pbcchain with -h works as expected."""

from test_framework.test_framework import PbcchainTestFramework
from test_framework.util import assert_equal

class HelpTest(PbcchainTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pbcchain with -h for help text")
        ...
        self.log.info("Start pbcchain with -version for version information")
        ...
        self.log.info("Start pbcchaind with -fakearg to make sure it does not start")
