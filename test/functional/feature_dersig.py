...
class BIP66Test(PbcchainTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # pbcchaind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and pbcchaind produces more specific reject
            # reasons.
